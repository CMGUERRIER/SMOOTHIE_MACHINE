package net.tailoredfitness.smoothie_machine.ui;
...
import net.tailoredfitness.smoothie_machine.util.ViewUtil;
...
public class Appearance {
    ...
    private static float getFocusBorderWidthPixels(Context context) {
        ...
        return (ViewUtil.typedDimensionValueToPixels(FOCUS_BORDER_PADDING, context) / 2.0f)
                * scale;
    }
